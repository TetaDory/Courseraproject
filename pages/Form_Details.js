...
class formDetails{
    constructor(page){
        this.page=page;
        this.dppCheckbox ='#mat-checkbox-4 > .mat-checkbox-layout > .mat-checkbox-inner-container'
...
async validateTitle(heading,titleName){
 ...
 async names(locatorName,name){
    ...
    await this.page.getByPlaceholder(locatorName).fill(name);
...
// choose either to use name or date of birth for verification
  if (verificationDetails.includes("names of")) {
    ...
    // const checkbox= await this.page.locator('#mat-checkbox-4 > .mat-checkbox-layout > .mat-checkbox-inner-container');
    // //await this.page.getByRole('button', { name: 'Verify' }).click();
    // console.log('Checkbox locatot', checkbox)
    if(await this.page.$(this.dppCheckbox)!==null){
